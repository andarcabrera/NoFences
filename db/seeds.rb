...
transportation = Category.find_or_create_by!(name: "Transport")
...
chinese = Language.find_or_create_by(name:"Chinese")
polish = Language.find_or_create_by(name:"Polish")
korean = Language.find_or_create_by(name:"Korean")
russian = Language.find_or_create_by(name:"Russian")
arabic = Language.find_or_create_by(name:"Arabic")
romanian = Language.find_or_create_by(name:"Romanian")
macedonian = Language.find_or_create_by(name:"Macedonian")
french = Language.find_or_create_by(name:"French")
